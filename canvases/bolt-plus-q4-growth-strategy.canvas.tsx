    ...
    <Stack gap={24}>
      ...
      <Table
        ...
        rows={[
          ...
          [
            ...
            "ROAS менше 1 протягом 4 тижнів",
      ...
      <Table
        ...
        rows={[
          ...
          ["Прибуток по сегментах", "Раз на 2 тижні", "Yaroslav", "SMB-прибуток впав більше 10%"],
          ["DI для McD/KFC", "Щомісяця", "Viacheslav", "DI ростуть, партнери нічого не дають"],
          ["ROI кампаній", "На кожен тест", "Growth", "ROI менше 1 при масштабуванні"],
        ]}
      />
        ...
        <CardBody>
          <Stack gap={8}>
            ...
            <Text>
              ...
              ~€8,5k/міс. Обережний Q4: 17,5–18%; базовий: 19–20%; upside:
